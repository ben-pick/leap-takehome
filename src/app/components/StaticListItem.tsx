...
export default function StaticListItem({ title, description, id, setIsEditing }: StaticListItemProps ) {
    const [state, formAction, pending] = useActionState(() => removeResponse(id), {
        message: "",
        success: true
    })
  ...
  return (
    <div>
        <div className="flex gap-2">
            ...
            <div>
            <button type="button" onClick={() => setIsEditing(true)} disabled={pending}>
              <EditIcon />
            </button>
            </div>
